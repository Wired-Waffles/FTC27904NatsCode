...
@Autonomous(name = "Blue far gate intake 21", group = "Far zone")
public class BlueFarZoneSolo21 extends LinearOpMode {
    ...
    Pose startPose = new Pose(56, 7.5, Math.toRadians(90));
    Pose pickupMiddleSpikePose = new Pose(18, 60);
    ...
    Pose gateIntake = new Pose(13, 60, Math.toRadians(153));
    ...
    public void buildPaths(){
        pickUpMiddleSpike = follower.pathBuilder()
                .addPath(new BezierCurve(startPose, new Pose(56, 60), pickupMiddleSpikePose))
                .addPath(new BezierCurve(pickupMiddleSpikePose, new Pose(56, 60), shootPoseOne))
                .build();
        pickUpCloseSpike = follower.pathBuilder()
                .addPath(new BezierCurve(shootPoseOne, new Pose(56, 35), pickUpCloseSpikePose))
                .addPath(new BezierCurve(pickUpCloseSpikePose, new Pose(56, 35), shootPoseOne))
                .build();
        ...
        toGateIntake = follower.pathBuilder()
                .addPath(new BezierCurve(shootPoseOne, new Pose(42, 45), gateIntake))
                .build();

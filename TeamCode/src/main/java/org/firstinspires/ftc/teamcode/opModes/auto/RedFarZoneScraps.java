...
@Autonomous(name = "Red partner far zone", group = "Far zone")
public class RedFarZoneScraps extends LinearOpMode {
    ...
    Pose startPose = new Pose(88, 8.5, Math.toRadians(0));
    Pose pickUpCloseSpikePose = new Pose(132, 36);
    Pose shootPoseOne = new Pose(88, 16);
    Pose shootPoseTwo = new Pose(98, 9, Math.toRadians(0));
    Pose humanPlayerPickupPose = new Pose(132,9);
    Pose humanPlayerPickupHigherPose = new Pose(132, 13);
    Pose secretTunnelAlignPose = new Pose(136, 13, Math.toRadians(90));
    Pose purgeTunnelArtifactsPose = new Pose (136,40);
    ...
    public void buildPaths(){
        pickUpCloseSpike = follower.pathBuilder()
                .addPath(new BezierCurve(startPose, new Pose(91, 40), pickUpCloseSpikePose))
                .setConstantHeadingInterpolation(startPose.getHeading())
                .addPath(new BezierCurve(pickUpCloseSpikePose, new Pose(93, 34), shootPoseOne))
        ...
        purgeSecretTunnelFromHuman = follower.pathBuilder()
                .addPath(new BezierCurve(humanPlayerPickupPose, new Pose(127, 11), secretTunnelAlignPose))
                ...
                .addPath(new BezierCurve(purgeTunnelArtifactsPose, new Pose(106, 41), shootPoseTwo))
